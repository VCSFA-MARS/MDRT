...
%   CMDRTSubplot( parentFigure )
%   CMDRTSubplot( plotsHigh, plotsWide )
%   CMDRTSubplot( plotsHigh, plotsWide, gap )
%   CMDRTSubplot( plotsHigh, plotsWide, gap, marginWidth )
%   CMDRTSubplot( plotsHigh, plotsWide, gap, marginHeight )
%   CMDRTSubplot( plotsHigh, plotsWide, gap, marginWidth, marginHeight )
%
