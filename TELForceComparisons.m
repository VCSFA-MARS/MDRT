...
for setnum = 1:numel(dataSetPath)
    ...
    [val, posind, forceind] = intersect(telpos.Time, forcea.Time);
    

    scatter(haxpair(1), telpos.Data(posind), forcea.Data(forceind), ...
            markers{markerInd}, ...
            'markerEdgeColor',      colors{colorInd}, ...
            'displayname',          metaData.operationName);
        
   
    scatter(haxpair(2), telpos.Data(posind), forceb.Data(forceind), ...
            markers{markerInd}, ...
            'markerEdgeColor',      colors{colorInd}, ...
            'displayname',          metaData.operationName);
	
	
    scatter(haxpair(3), telpos.Data(posind), forceb.Data(forceind) - forcea.Data(forceind), ...
            markers{markerInd}, ...
            'markerEdgeColor',      colors{colorInd}, ...
            'displayname',          metaData.operationName);
