...
if isa(hObj,  'matlab.ui.control.EditField')
...
if ~isempty(searchString)
  ...
  if use_web
    % nothing matters in this case
    lsr.Items = masterList(ind);
  elseif length(masterList(ind)) >= lsr.Value
  ...
  if use_web
    lsr.Items = masterList;
  elseif shouldHideEmptyListbox
